...
class BoundsTesterTest {
  private Boolean xInB(int x) { return BoundsTester.xInBounds(x); }
  private Boolean yInBNUL(int y) { return BoundsTester.yInBoundsNoUpperLimit(y); }
  private Boolean yInB(int y) { return BoundsTester.yInBounds(y); }
  ...
  void yInBoundsNoUpperLimit() {
    assertAll("yInBoundsNoUpperLimit",
